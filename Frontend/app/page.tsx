...
export default function DashboardPage() {
  ...
  return <main className="app-shell"><DashboardHeader /><SummaryCards history={history} /><div className="dashboard-grid"><section className="panel form-panel"><div className="panel-heading"><div><p className="eyebrow">New assessment</p><h2>Assess student indicators</h2></div><span className="live-label"><span /> API connected</span></div><PredictionForm onPrediction={handlePrediction} /></section><section className="panel result-panel"><div className="panel-heading"><div><p className="eyebrow">Latest result</p><h2>Prediction result</h2></div><span className="panel-code">01</span></div><PredictionResult prediction={prediction} /></section></div><section className="panel"><div className="panel-heading"><div><p className="eyebrow">Model interpretation</p><h2>Contributing factors</h2></div><span className="panel-code">02</span></div><ContributingFactors factors={prediction?.contributingFactors} /></section><section className="panel"><div className="panel-heading"><div><p className="eyebrow">Recorded assessments</p><h2>Prediction history</h2></div><span className="panel-code">03</span></div>{historyLoading ? <LoadingState label="Loading prediction history..." /> : <PredictionHistory history={history} error={historyError} />}</section><footer className="app-footer"><span>Student Support Risk Prediction System</span><span>Prediction support tool / review with care</span></footer></main>;
}
